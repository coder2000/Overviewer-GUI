...
namespace OverviewerGUI
{
    public partial class MainWindow : Form
    {
        ...
        {
            Settings.Default.mapDir = worldFolder.Text;
            Settings.Default.outputDir = outputFolder.Text;
        ...
        private void proc_DataReceived(object sender, DataReceivedEventArgs e)
        {
            ...
            if (!_haltedRender)
            {
                ...
                {
                    foreach (string per in startExpression.Split(stripTiles).SelectMany(sub => perExpression.Split(sub))
                        )
                    {
        ...
        public String GetSplash()
        {
            ...
            int n = random.Next(0, _splashes.Length);
            return _splashes[n];
        }
